...
my $peek_color       = '6666660';     # grey
my $alu_color        = '4444440';     # dark grey
my $hvcover_color    = '4444440';    # dark grey semi-transparent
my $pcb_color        = '0000ff0';     # blue
my $copper_color     = '6666000';     # greenish (dark)
my $strips_color     = '3535400';
my $gas_color        = 'e100003';
my $photoresist_color= 'aa00aa0';     # purple
my $mesh_color       = '2520200';     # black
my $air_color	      = 'e200e12';
my $kapton_color     = 'fff6000';    # yellowish transparent (active zone)
my $rohacell_color   = '00ff000';     # green
my $resist_color     = '0000000';
my $connector_color  = 'aa00000';
#myGlue
 ...
 #   my $descriptio = "HVcover, Layer $layer_no, ";
	...
	for(my $c = 0; $c < 2 ; $c++)   # 2 HV cover per disk
	{
		...
		for(my $e = 0; $e < 4 ; $e++)   # 4 elements compose a HV cover
		{
			...
			my %detector = init_det();
			$detector{"name"}        = "$vname$cover_no\_$layer_no\_$element_no";
			$detector{"mother"}      = $envelope;
			$detector{"description"} = "$descriptio";
			$detector{"pos"}         = "$tpos $z*mm";
...
sub place_spacers
{
	...
	# units = mm, deg. ;
	# these spacers ("entretoises") are screwed on the supports; their length is such as to fill the available space between 2 spacers = 10.5 - 5 = 5.5 mm
