...
#	print_det(\%configuration, \%detector);
	...
	$detector{"dimensions"}  = "0.0*deg 360*deg 4*counts 0.0*mm 0.0*mm 0.0*mm 0.0mm 30.*mm 30*mm 25.46*mm 41.2*mm 60.85*mm 384.98*mm 384.98*mm 570*mm";
	...
	$detector{"type"}        = "Cons";
	$detector{"pos"}         = "0*mm 0*mm $zpos*mm";
	$detector{"dimensions"}  = "38.1*mm 54.02*mm 38.1*mm 98.64*mm 255.04.*mm 0.0*deg 360*deg";
	$detector{"material"}    = "G4_W";
	$detector{"style"}       = 1;
	print_det(\%configuration, \%detector);
