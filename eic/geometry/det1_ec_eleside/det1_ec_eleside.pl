...
#####Load geometry ########################################################
require "det1_ec_eleside_geometry.pl";
det1_ec_eleside();
require "det1_ec_inner_eleside_geometry.pl";
det1_ec_inner_eleside();
require "det1_ec_eleside_virtualplane.pl";
det1_ec_eleside_virtualplane();
require "det1_ec_inner_eleside_virtualplane.pl";
det1_ec_inner_eleside_virtualplane();
