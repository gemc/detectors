...
foreach my $conf ( @allConfs )
{
	...
	if($configuration{"variation"} eq "original")
	{
		...
		system("groovy -cp '/work/clas12/users/efuchey/coatjava/coatjava/lib/clas/coat-libs-10.1.1-SNAPSHOT.jar' factory.groovy --variation $configuration{variation} --runnumber 11");
