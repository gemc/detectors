...
sub define_ahdc_bank
{
	...
	insert_bank_variable(\%configuration, $bankname, "wireNum",         3, "Di", "the AHDC cell number, from 1!");
	insert_bank_variable(\%configuration, $bankname, "adc",            4, "Dd", "ADC");
	insert_bank_variable(\%configuration, $bankname, "time" ,           5, "Dd", "time");
