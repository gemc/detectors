...
sub define_bank
{
   ...
   insert_bank_variable(\%configuration, $bankname, "ADCHD",        5, "Di", "13 bit ADC");
	insert_bank_variable(\%configuration, $bankname, "time",         6, "Dd", "Time information");
   insert_bank_variable(\%configuration, $bankname, "bco",          7, "Di", "8 bit time info");
