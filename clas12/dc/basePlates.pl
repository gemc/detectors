...
sub make_plates
{
   ...
   for(my $iregion=0; $iregion<3; $iregion++)
   {
	   ...
	   $detector{"dimensions"}  = "$mother_dy[$iregion] 0*deg 0*deg $pl_thick*cm $pl_bottom[$iregion]*cm $pl_top[$iregion]*cm 0*deg $pl_thick*cm $pl_bottom[$iregion]*cm $pl_top[$iregion]*cm 0*deg";
