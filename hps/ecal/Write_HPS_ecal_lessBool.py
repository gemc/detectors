...
#
    ...
    ecal_sens.add_bank_row("hitn","Hit number",0,"Di")
    ecal_sens.add_bank_row("ih","Horizontal index for crystal",1,"Di")
    ecal_sens.add_bank_row("iv","Vertical index for crystal",2,"Di")
