...
#####Load geometry ########################################################
require "det1_beamline_pipe_ionside.pl";
det1_beamline_pipe_ionside();
require "det1_beamline_pipe_eleside.pl";
det1_beamline_pipe_eleside();

#materials definition 
require "./det1_beamline_pipe_materials.pl";
